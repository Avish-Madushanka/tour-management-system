            ...
            <div class="h-64 rounded-md overflow-hidden bg-cover bg-center" style="background-image: url('https://images.unsplash.com/photo-1577655197620-704858b270ac?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1280&q=144')">
                <div class="bg-gray-900 bg-opacity-50 flex items-center h-full">
                    <div class="px-10 max-w-xl">
                        <h2 class="text-2xl text-white font-semibold">Accomadation</h2>
                        <p class="mt-2 text-gray-400">"Embark on a journey of comfort and serenity with our exceptional accommodations. From cozy retreats to lavish suites, immerse yourself in luxury and make every moment unforgettable. Your home away from home awaits, where comfort meets excellence."</p>
